...
This software has been written by [Rafayel Mkrtchyan][web1]. I started researching the mechanics of BIOS and HDD password in current generation laptops in 2012. 
